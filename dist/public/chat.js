...
btn = document.getElementById("send"), output = document.getElementById("output"), feedback = document.getElementById("feedback"), popup = document.querySelector(".chat-popup"), chatbtn = document.querySelector(".chat-btn");
